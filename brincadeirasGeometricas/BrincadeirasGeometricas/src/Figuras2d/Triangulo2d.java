...
public class Triangulo2d implements GLEventListener, KeyListener {
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        gl.glVertex3f(0.5f,0.7f,0.0f);      //base do triangulo

        gl.glColor3f( 0f,1f,0f ); //verde
        gl.glVertex3f(-0.5f,0.6f,0.0f);  //lado esquerdo
      //  gl.glVertex3f(-0.2f,-0.5f,0.0f);  //lado esquerdo

        gl.glColor3f( 0f,1f, 1f ); //azul claro
        gl.glVertex3f(0.5f,-0.5f,0.0f);   //lado direito
